...
puts 'Create jobs'
j = Job.create(title: 'Owner and Developer', started_at: Date.new!(2011, 9), description: 'Owner and developer of a indie Android games company. Mostly developing for Android, but included in some web projects as well.')

puts 'Create places'
chillbro = Place.create!(title: 'chillbro studios AB', job: j, location: 'Linkoping, Sweden', website: 'http://chillbro.net/')
